...
public class ReservarAlojamientoPage extends PageObject {
    ...
    public void numHuespedes() {
        ...
        //act.moveToElement(btnPage2).click().perform();


        /*String [] contenedor=($()).getText().split(" ");
        int valormin= Integer.parseInt(contenedor[0]);
        int valormax=Integer.parseInt(contenedor[2]);
